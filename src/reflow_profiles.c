...
static const profile ts391snlprofile = {
	"TS391SNL Sn97/Ag3", {
        ...
        195,204,213,222,217,200,160,120,100,90,80,70,65,60,57,54,51,48,45,43,41,40,40,40
	}
};
...
static const profile ts391axprofile = {
	"TS391AX Sn63/Pb37", {
        ...
        205,200,160,120,90,80,70,65,60,57,54,51,48,45,43,41,40,40,40,40,40,40,40,40
	}
};
